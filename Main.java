...
public class Main {
    ...
    // In Java programs, the point from where the program starts its 
    // execution or simply the entry point of Java programs is the 
    // main() method
    ...
    public static void main(String[] args) {
        ...
        // the number entered is less than 0, prompt the user
        // again until the number entered is greater than or equal to 0.
        // Once you have a number that is greater than or equal to 0, 
        // prompt the user for a second number. Ensure the second
        // number is greater than or equal to 0. Once you have two
        // numbers, call the printPrime function with those values.

        // Create two variables, of type integer, to store the
        // low and high numbers
        int first = -1; // Start with a negative number
        int second = -1; // Start with a negative number

        // Scanner is an object. We are creating an instance of
        // this object to use to accept user input. It is 
        // available in the util package/library, which we imported above
        // We pass it an argument, System.in which is a class that
    ...
    public static void printPrime(int first, int second) {
        ...
        // Check to see if any prime numbers were found
...
// 3. Calculate and display a running sum of all the prime numbers
//    identified (advanced)